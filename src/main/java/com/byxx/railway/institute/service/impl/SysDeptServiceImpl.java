...
import com.byxx.railway.institute.common.enums.StatusEnum;
import com.byxx.railway.institute.common.model.Option;
import com.byxx.railway.institute.converter.DeptConverter;
import com.byxx.railway.institute.mapper.SysDeptMapper;
...
import com.byxx.railway.institute.service.SysDeptService;
        ...
        Optional.ofNullable(Arrays.stream(ids.split(",")))
                .ifPresent(deptIds -> deptIds.forEach(deptId ->
                        this.remove(new LambdaQueryWrapper<SysDept>()
                                ...
                                .or()
                                .apply("tree_path like concat(concat('%',{0}),'%')", deptId))
                ));
        return true;
    }
